              ...
              return (
                <li key={item.id}>
                  <button
                    ...
                    className={cn(
                      'sidebar-menu-item w-full flex items-center transition-all duration-300 border-0 bg-transparent cursor-pointer group',
                      sidebarCollapsed 
                        ? 'justify-center p-2 w-[48px] h-[48px] rounded-lg mx-auto' 
                        : 'justify-start space-x-3 px-3 py-2 hover:translate-x-1 rounded-lg',
                      item.active 
